...
cov <- c("Agreement","Adjudication/Arbitration","Conflict","Homeland","Rivalry")
...
summary(i2)
i3 = glm(window10 ~ agreement*conflict + contlose + rivals, data=data, family=binomial(logit))
summary(i3)
...
interactions <- c("Agreement","Conflict","Homeland","Rivalry","Agreement x Conflict")
...
r3 = sim(z2,x=x3.5)
summary(r3)
x4.5 = setx(z3,agreement=0,contlose=1,conflict=0,rivals=0)
x5.5 = setx(z3,agreement=0,contlose=1,conflict=0,rivals=1)
r4 = sim(z3,x=x4.5)
summary(r4)
r5 = sim(z3,x=x5.5)
summary(r5)
