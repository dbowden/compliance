...
data <- subset(data, select=c(year,dyad,dispnum3,claimdy,mid1,window5,window10,window20,claim1,outstanding.claim.5,outstanding.claim.10,outstanding.claim.20))
...
#create a few twists on claims analysis
